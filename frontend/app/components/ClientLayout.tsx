...
export default function ClientLayout({ children }: ClientLayoutProps) {
  ...
  const isFullScreenPage = pathname.startsWith('/credential-designer/') && pathname !== '/credential-designer';
  ...
  }, [isLoading, isAuthenticated, isPublicPage, isFullScreenPage, router]);
          ...
          <div className="flex flex-col h-full bg-primary relative overflow-hidden">
            ...
            <nav className="flex-1 px-4 py-6 overflow-y-auto">
              <div className="space-y-1">
                ...
                >
                  <div className={`${pathname === '/calls' ? 'bg-white/20 text-white shadow-sm' : 'text-text-tertiary group-hover:text-primary-600 group-hover:bg-primary-50'}
